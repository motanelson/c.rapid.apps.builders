...
def parse_pythontree_tree(file_path):
...
def main():
    file_name = input("Enter the name of the .pi python language file to load: ")

    try:
        tree = parse_pythontree_tree(file_name)
        print("\nParsed python language Tree:")
        print(tree)
